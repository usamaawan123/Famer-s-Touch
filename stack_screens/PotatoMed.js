...
export default function PotatoMed() {
    const [users, setUsers] = useState(null);
    const todoref = firebase.firestore().collection('Potatoe')
    useEffect(() => {
        todoref
            .onSnapshot(
                querySnapshot => {
                    ...
                    querySnapshot.forEach((doc) => {
                        const { Name1, Des1, Name2, Des2, Name3, Des3, Name4, Name5, Des4, Des5 } = doc.data()
                        users.push({
                            id: doc.id,
                            Name1,
                            Des1,
                        ...
                        <View>
                            ...
                            <ScrollView horizontal={true}>
                                <Image
                                    ...
                                    source={require("../assets/PotatoMed/Medicine1.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/PotatoMed/Medicine2.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/PotatoMed/Medicine3.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/PotatoMed/Medicine4.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/PotatoMed/Medicine5.png")}
                                ></Image>
                            </ScrollView>
