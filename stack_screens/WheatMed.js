...
export default function WheatMed() {
    const [users, setUsers] = useState(null);
    const todoref = firebase.firestore().collection('Wheat')
    useEffect(() => {
        todoref
            .onSnapshot(
                querySnapshot => {
                    ...
                    querySnapshot.forEach((doc) => {
                        const { Name1, Des1, Name2, Des2, Name3, Des3, Name4, Name5, Des4, Des5, Name6, Des6 } = doc.data()
                        users.push({
                            id: doc.id,
                            Name1,
                            Des1,
                        ...
                        <View>
                            ...
                            <ScrollView horizontal={true}>
                                <Image
                                    ...
                                    source={require("../assets/CornMed/Medicine1.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/CornMed/Medicine2.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/CornMed/Medicine3.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/CornMed/Medicine4.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/CornMed/Medicine5.png")}
                                ></Image>
                                <Image
                                    style={{
                                        height: responsiveHeight(30),
                                    ...
                                    source={require("../assets/CornMed/Medicine6.png")}
                                ></Image>
                            </ScrollView>
